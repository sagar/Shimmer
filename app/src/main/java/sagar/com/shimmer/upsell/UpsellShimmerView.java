...
public class UpsellShimmerView extends AppCompatImageView {

  private static final String TAG = UpsellShimmerView.class.getSimpleName();
  ...
  public UpsellShimmerView(Context context) {
    this(context, null);
  }

  public UpsellShimmerView(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
  ...
  public float[] updateColorPositions(float fraction) {
    ...
    //positions[0] = UpsellShimmerViewActivity.orientationAngles[2] + fraction;
