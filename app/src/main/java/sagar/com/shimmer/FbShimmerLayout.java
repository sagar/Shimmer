...
public class FbShimmerLayout extends FrameLayout {
  ...
  private static final String TAG = "FbShimmerLayout";
  ...
  public FbShimmerLayout(Context context) {
    this(context, null, 0);
  }

  public FbShimmerLayout(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public FbShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FbShimmerLayout, 0, 0);
      try {
        if (a.hasValue(R.styleable.FbShimmerLayout_auto_start)) {
          setAutoStart(a.getBoolean(R.styleable.FbShimmerLayout_auto_start, false));
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_base_alpha)) {
          setBaseAlpha(a.getFloat(R.styleable.FbShimmerLayout_base_alpha, 0));
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_duration)) {
          setDuration(a.getInt(R.styleable.FbShimmerLayout_duration, 0));
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_repeat_count)) {
          setRepeatCount(a.getInt(R.styleable.FbShimmerLayout_repeat_count, 0));
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_repeat_delay)) {
          setRepeatDelay(a.getInt(R.styleable.FbShimmerLayout_repeat_delay, 0));
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_repeat_mode)) {
          setRepeatMode(a.getInt(R.styleable.FbShimmerLayout_repeat_mode, 0));
        }

        if (a.hasValue(R.styleable.FbShimmerLayout_angle)) {
          int angle = a.getInt(R.styleable.FbShimmerLayout_angle, 0);
          switch (angle) {
            default:
            case 0:
        ...
        if (a.hasValue(R.styleable.FbShimmerLayout_shape)) {
          int shape = a.getInt(R.styleable.FbShimmerLayout_shape, 0);
          switch (shape) {
            default:
            case 0:
        ...
        if (a.hasValue(R.styleable.FbShimmerLayout_dropoff)) {
          mMask.dropoff = a.getFloat(R.styleable.FbShimmerLayout_dropoff, 0);
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_fixed_width)) {
          mMask.fixedWidth = a.getDimensionPixelSize(R.styleable.FbShimmerLayout_fixed_width, 0);
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_fixed_height)) {
          mMask.fixedHeight = a.getDimensionPixelSize(R.styleable.FbShimmerLayout_fixed_height, 0);
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_intensity)) {
          mMask.intensity = a.getFloat(R.styleable.FbShimmerLayout_intensity, 0);
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_relative_width)) {
          mMask.relativeWidth = a.getFloat(R.styleable.FbShimmerLayout_relative_width, 0);
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_relative_height)) {
          mMask.relativeHeight = a.getFloat(R.styleable.FbShimmerLayout_relative_height, 0);
        }
        if (a.hasValue(R.styleable.FbShimmerLayout_tilt)) {
          mMask.tilt = a.getFloat(R.styleable.FbShimmerLayout_tilt, 0);
        }
      } finally {
        a.recycle();
      }
  ...
  private Bitmap tryCreateRenderBitmap() {
    ...
    try {
      ...
      String logMessage = "FbShimmerLayout failed to create working bitmap";
